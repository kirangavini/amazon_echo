...
var questions = [
    {
        "What is truck associated with": [
            "arrow"
        ]
    },
    {
        "What is insect associated with?": [
            "acron"
            
        ]
    },
    {
        "What is reptile associated with?": [
            "clown"
        ]
    },
    {
        "What is bank associated with?": [
            "cartoon"
        ]
    },
    {
        "What is star associated with?": [
            "Ladder"
        ]
    },
    {
        "What is racoon associated with?": [
            "paper"
        ]
    },
    {
        "What is rose associated with?": [
            "bag"
        ]
    },
    {
        "What is elephant associated with?": [
            "glass"
        ]
    },
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 8;
var CARD_TITLE = " Verbal pair associates"; // Be sure to change this for your skill.

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Hi, I will give you" + GAME_LENGTH.toString()
            + "pair of words and later ask you for the respective word attached to the pair <break time = \"0.7s\"/>" + "the pair of words are" +
            "Truck<break time = \"0.5s\"/>-Arrow" + 
            " <break time = \"3.0s\"/>Insect-<break time = \"0.5s\"/>Acron" + 
            "<break time = \"3.0s\"/>Reptile-<break time = \"0.5s\"/>Clown" +
             "<break time = \"3.0s\"/>Bank- <break time = \"0.5s\"/>Cartoon" + 
            "<break time = \"3.0s\"/>Star-<break time = \"0.5s\"/>Ladder" +
             "<break time = \"3.0s\"/>Racoon-<break time = \"0.5s\"/>paper" +
              "<break time = \"3.0s\"/>Rose-<break time = \"0.5s\"/>Bag" + 
              "<break time = \"3.0s\"/>Elephant-<break time = \"0.5s\"/>Glass"
            ,
