...
var questions = [
    {
        "<break time = \"1.0s\"/> Was the woman's name Diana Thompson?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Was the story setting in South Boston?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Was the woman a cook?": [
            "true"
        }
    },
    {
        "<break time = \"0.5s\"/> Did she work in a Bank?": [
            "false"
        ]
    },
    {
        "<break time = \"0.2s\"/> Did she have four children?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Were the children teenagers?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the robbery take place on Sixth Street?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the woman report being robbed two nights before?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did she report the robbery at the police station?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Was the woman robbed of 75 dollars?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the family go without food for four days?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Was the rent due?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the police catch the theif<break time = \"0.5s\"/>?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the police feel sorry for the woman?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Did the police take up a collection?": [
            "true"
        ]
    },
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 15;
var CARD_TITLE = "story questions two"; 
var cardspeech = "This skill is used to recognize different sentences from story memory two skill which provides different stories and this skill asks question based on those stories";

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Do you remember the story I told you before about Diana thompson? <break time = \"0.5s\"/>Now, I am going to ask you few questions. <break time = \"0.5s\"/>You can either answer them as true or false. <break time = \"0.5s\"/>Remember, only to use true or false as your answer. Let's begin<break time = \"0.5s\"/>",
