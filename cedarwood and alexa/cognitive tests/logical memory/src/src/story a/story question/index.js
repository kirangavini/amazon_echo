...
var questions = [
    {
        "<break time = \"1.0s\"/> Is one of the people in the story named Ruth?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Is the other person named Paul ?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Does the story say that two people are married?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Have they been friends for twenty years?": [
            "false"
        ]
    },
    {
        "<break time = \"0.2s\"/> Do they meet every tuesday?": [
            "true"
        ]
    },
    {
        "<break time = \"0.5s\"/> Do they eat lunch at Mason's restaurant?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> After breakfast, do they watch birds at Paul's house?": [
            "false"
        ]
    },
    {
        "<break time = \"0.5s\"/> Do they walk in Mason park?": [
            "true"
        ]
    },
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 8;
var CARD_TITLE = "story questions one"; 

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Do you remember the story I told you before about two friends? <break time = \"0.5s\"/>Now, I am going to ask you few questions. <break time = \"0.5s\"/>You can either answer them as true or false. <break time = \"0.5s\"/>Remember, only to use true or false as your answer. Let's begin<break time = \"0.5s\"/>";
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "Recognise sentences from story and mark them as correct or incorrect based on what you heard in the story" 
