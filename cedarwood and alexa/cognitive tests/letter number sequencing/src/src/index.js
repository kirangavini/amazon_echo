...
var questions = [
   {
        "What would you say if I said   <break time = \"1.0s\"/><say-as interpret-as='spell-out'>6<break time = \"1.0s\"/>Q</say-as>?": [
            "6Q"
        ]
    },   
  {
        "What would you say if I said   <break time = \"1.0s\"/><say-as interpret-as='spell-out'>G<break time = \"1.0s\"/>3</say-as>?": [
            "3G"
        ]
    },
 {
 ...
 {
        "What would you say if I said  <break time = \"0.5s\"/><say-as interpret-as='spell-out'>W<break time = \"1.0s\"/>2<break time = \"1.0s\"/>P</say-as>?": [
            "2PW"
        ]
    },
 {
        "What would you say if I said  <break time = \"0.5s\"/><say-as interpret-as='spell-out'>2<break time = \"1.0s\"/>J<break time = \"1.0s\"/>A</say-as>?": [
            "2AJ"
        ]
    },            

    {
        " Level 1: What would you say if I said   <break time = \"1.0s\"/><say-as interpret-as='spell-out'>Q<break time = \"1.0s\"/>2</say-as>?": [
            "2Q"
        ]
    },
    {
    ...
    {
        "Level 2: What would you say if I said  <break time = \"0.5s\"/><say-as interpret-as='spell-out'>Y<break time = \"1.0s\"/>8<break time = \"1.0s\"/>R</say-as>?": [
            "8RY"
        ]
    },
    {
        "What would you say if I said    <break time = \"0.5s\"/><say-as interpret-as='spell-out'>R<break time = \"1.0s\"/>3<break time = \"1.0s\"/>D</say-as>?": [
            "3DR"
        ]
    },
    {
        "What would you say if I said    <break time = \"0.5s\"/><say-as interpret-as='spell-out'>H<break time = \"1.0s\"/>2<break time = \"1.0s\"/>8</say-as>?": [
            "28H"
        ]
    },
    {
    ...
    },
    {
        ...
        " What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>V<break time = \"1.0s\"/>2<break time = \"1.0s\"/>J<break time = \"1.0s\"/>5</say-as>?": [
            "25JV"
        ]
    },
    {
        "What would you say if I said   <break time = \"0.5s\"/><say-as interpret-as='spell-out'>6<break time = \"1.0s\"/>N<break time = \"1.0s\"/>3<break time = \"1.0s\"/>L</say-as>?": [
            "36LN"
        ]
    },
    {
        "Level 4: What would you say if I said  <break time = \"0.5s\"/><say-as interpret-as='spell-out'>8<break time = \"1.0s\"/>D<break time = \"1.0s\"/>6<break time = \"1.0s\"/>G<break time = \"1.0s\"/>2</say-as>?": [
            "268DG"
        ]
    },
    {
        "What would you say if I said    <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>K<break time = \"1.0s\"/>2<break time = \"1.0s\"/>C<break time = \"1.0s\"/>8<break time = \"1.0s\"/>S</say-as>?": [
            "28CKS"
        ]
    },
    {
    ...
    {
        "Level 5: What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>M<break time = \"1.0s\"/>4<break time = \"1.0s\"/>E<break time = \"1.0s\"/>8<break time = \"1.0s\"/>Q<break time = \"1.0s\"/>2</say-as>?": [
            "248EMQ"
        ]
    },
    {
        "What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>W<break time = \"1.0s\"/>8<break time = \"1.0s\"/>H<break time = \"1.0s\"/>5<break time = \"1.0s\"/>F<break time = \"1.0s\"/>3</say-as>?": [
            "358FHW"
        ]
    },
    {
    ...
    {
        "Level 6: What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>R<break time = \"1.0s\"/>3<break time = \"1.0s\"/>B<break time = \"1.0s\"/>4<break time = \"1.0s\"/>Z<break time = \"1.0s\"/>2<break time = \"1.0s\"/>C</say-as>?": [
            "234BCRZ"
        ]
    },
    {
        "What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>5<break time = \"1.0s\"/>T<break time = \"1.0s\"/>9<break time = \"1.0s\"/>J<break time = \"1.0s\"/>2<break time = \"1.0s\"/>X<break time = \"1.0s\"/>6</say-as>?": [
            "2569JTX"
        ]
    },
    {
        "What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>E<break time = \"1.0s\"/>3<break time = \"1.0s\"/>H<break time = \"1.0s\"/>8<break time = \"1.0s\"/>R<break time = \"1.0s\"/>4<break time = \"1.0s\"/>D</say-as>?": [
            "348DEHR"
        ]
    },
    {
    ...
    {
        "What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>D<break time = \"1.0s\"/>2<break time = \"1.0s\"/>R<break time = \"1.0s\"/>9<break time = \"1.0s\"/>B<break time = \"1.0s\"/>4<break time = \"1.0s\"/>K<break time = \"1.0s\"/>3</say-as>?": [
            "2349BDKR"
        ]
    },
    {
        "What would you say if I said  <break time = \"0.5s\"/> <say-as interpret-as='spell-out'>7<break time = \"1.0s\"/>M<break time = \"1.0s\"/>2<break time = \"1.0s\"/>T<break time = \"1.0s\"/>6<break time = \"1.0s\"/>F<break time = \"1.0s\"/>3<break time = \"1.0s\"/>Z</say-as>?": [
            "3267FMTZ"
        ]
    },
        ...
        //var xvalue;
                 ...
                 if (answerSlotValid && intent.slots.Answer.value == correctAnswerText) {
                  ...
                  if (currentQuestionIndex === 7 && currentScore ===0 ){
                            ...
                            speechOutput += "All of the questions in this level are wrong. Thank you for participating with Alexa!";
