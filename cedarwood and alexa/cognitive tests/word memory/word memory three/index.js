...
var questions = [
    {
        "<break time = \"1.0s\"/> Sugar <break time = \"1.5s\"/> Trumpet <break time = \"1.5s\"/> violin <break time = \"1.5s\"/> Coal <break time = \"1.5s\"/> Garlic <break time = \"1.5s\"/> Kerosene <break time = \"1.5s\"/> vanilla <break time = \"1.5s\"/> wood <break time = \"1.5s\"/> clarinet <break time = \"1.5s\"/> flute <break time = \"1.5s\"/> cinnamon <break time = \"1.5s\"/> gasoline <break time = \"1.5s\"/>Remember to answer true or false. Did you hear the word Sugar from the list?": [
            "true"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word garlic from the list?": [
            "true"
        ]
    },
    {
    ...
    {
        "<break time = \"1.0s\"/>did you hear the word Horse from the list?": [
            "false"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word gasoline from the list?": [
            "true"
        ]
    },
    {
    ...
    {
        "<break time = \"1.0s\"/>did you hear the word trumpet from the list?": [
            "true"
        ]
    },
    {
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 10;
var CARD_TITLE = "word memory two"; 
