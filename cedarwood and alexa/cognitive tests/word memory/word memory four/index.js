...
var questions = [
    ...
    {
        "<break time = \"1.0s\"/>did you hear the word hotel from the list?": [
            "false"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word vanilla from the list?": [
            "false"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word bomb from the list?": [
            "true"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the wood pot from the list?": [
            "false"
        ]
    },
    {
    ...
    {
        "<break time = \"1.0s\"/>did you hear the word bourbon from the list?": [
            "true"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word wine from the list?" : [
             "true"
        ]
    },
    {
        "<break time = \"1.0s\"/>did you hear the word pot from the list?" : [
             "true"
        ]
    }
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 10;
var CARD_TITLE = "word memory three"; 
