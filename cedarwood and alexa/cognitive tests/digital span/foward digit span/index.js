...
function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = " In numbers forward, <break time = \"0.5s\"/> you will be asked to repeat the numbers as said by alexa. There will be different items in a task. If you fail to answer all the questions in an item, task will" 
              + " end. <break time = \"0.5s\"/>Now, I am going to say some numbers. Listen carefully,and when I am through, I want you to say them right after me. Just say what I say. Let's begin<break time = \"2.0s\"/>",
