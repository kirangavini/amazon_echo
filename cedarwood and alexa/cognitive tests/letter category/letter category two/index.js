...
var questions = [
    {
        " <break time = \"1.0s\"/> The first letter is B. B as in bear. After the tone, write down all the words that you can think of that begin with that letter.<break time = \"3.0s\"/>your timer starts now <audio src='https://s3.amazonaws.com/beepsound/beep2.mp3'/> <break time = \"10.s\"/><break time = \"10.s\"/><break time = \"10.s\"/>, thirty seconds down,keep trying<break time = \"10.s\"/><break time = \"10.s\"/><break time = \"3.s\"/><audio src='https://s3.amazonaws.com/beepsound/countdown1.mp3'/> Stop. Now, <break time = \"0.5s\"/>say continue in order to go to next question?": [
            "continue"
        ]
    },
    {
        " <break time = \"1.0s\"/> The next letter is P. P as in pig. After the tone, write down all the words that you can think of that begin with that letter.<break time = \"3.0s\"/>your timer starts now <audio src='https://s3.amazonaws.com/beepsound/beep2.mp3'/> <break time = \"10.s\"/><break time = \"10.s\"/><break time = \"10.s\"/>, thirty seconds down,keep trying<break time = \"10.s\"/><break time = \"10.s\"/><break time = \"3.s\"/><audio src='https://s3.amazonaws.com/beepsound/countdown1.mp3'/> Stop. Now, <break time = \"0.5s\"/>say continue in order to go to next question?": [
            "continue"
        ]
    },
    {
        " <break time = \"1.0s\"/> The next letter is E. E as in elephant. After the tone, write down all the words that you can think of that begin with that letter.<break time = \"3.0s\"/>your timer starts now <audio src='https://s3.amazonaws.com/beepsound/beep2.mp3'/> <break time = \"10.s\"/><break time = \"10.s\"/><break time = \"10.s\"/>, thirty seconds down,keep trying<break time = \"10.s\"/><break time = \"10.s\"/><break time = \"3.s\"/><audio src='https://s3.amazonaws.com/beepsound/countdown1.mp3'/> Stop. Now, <break time = \"0.5s\"/>say continue in order to exit the game and go to the next page in your notebook?": [
            "continue"
        ]
    },
...
var ANSWER_COUNT = 1;
var GAME_LENGTH = 3;
var CARD_TITLE = "Letter category task 2"; 
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing letter category task!", "", true));
}
